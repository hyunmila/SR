...
HD_PWD='C:/Users/ja/Documents/SR/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_kaskada_bramek_and.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_kaskada_bramek_and.tcl
